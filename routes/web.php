...
Route::middleware(['auth'])->group(function () {
    ...
    // =============================================
    // PEMBAYARAN PULSA
    // FIX: kelas routes MUST come before /{pembayaranPulsa} wildcard
    // =============================================
    Route::prefix('pembayaran/pulsa')->name('pembayaran-pulsa.')->group(function () {
        ...
        // ⚠️ Kelas routes HARUS sebelum /{id} agar tidak tertangkap wildcard
    ...
    // =============================================
    // PEMBAYARAN ASURANSI
    // FIX: sama, kelas routes HARUS sebelum /{id}
    // =============================================
    Route::prefix('pembayaran/asuransi')->name('pembayaran-asuransi.')->group(function () {
        ...
        // ⚠️ Kelas routes HARUS sebelum /{id}
