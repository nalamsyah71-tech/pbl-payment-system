...
<?php $__env->startSection('title', 'Input Pembayaran Pulsa'); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
        ...
        <form method="POST" action="<?php echo e(route('pembayaran-pulsa.store')); ?>" id="formPulsa">
            <?php echo csrf_field(); ?>
            ...
            <div class="flex gap-3">
                ...
                <a href="<?php echo e(route('pembayaran-pulsa.index')); ?>" class="px-6 py-2 border border-slate-300 rounded-lg text-slate-600 hover:bg-slate-50">
                    Batal
                </a>
            </div>
        </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\pbl-payment-system\resources\views/pembayaran/pulsa/create.blade.php ENDPATH**/ ?>