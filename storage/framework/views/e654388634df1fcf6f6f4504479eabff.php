...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'PBL Payment System'); ?> – Sistem Pembayaran Peserta</title>
    ...
    >
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-2 space-y-1">
            ...
            <a href="<?php echo e(route('dashboard')); ?>"
               class="sidebar-item <?php echo e(request()->routeIs('dashboard') ? 'sidebar-active' : ''); ?>">
            ...
            <a href="<?php echo e(route('kejuruan.index')); ?>"
               class="sidebar-item <?php echo e(request()->routeIs('kejuruan.*') ? 'sidebar-active' : ''); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('pelatihan.index')); ?>"
               class="sidebar-item <?php echo e(request()->routeIs('pelatihan.*') ? 'sidebar-active' : ''); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('kelas.index')); ?>"
               class="sidebar-item <?php echo e(request()->routeIs('kelas.*') ? 'sidebar-active' : ''); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('peserta.index')); ?>"
               class="sidebar-item <?php echo e(request()->routeIs('peserta.*') ? 'sidebar-active' : ''); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('pembayaran-pulsa.index')); ?>"
               class="sidebar-item <?php echo e(request()->routeIs('pembayaran-pulsa.*') ? 'sidebar-active' : ''); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('pembayaran-asuransi.index')); ?>"
               class="sidebar-item <?php echo e(request()->routeIs('pembayaran-asuransi.*') ? 'sidebar-active' : ''); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('pembayaran-uang-saku.index')); ?>"
               class="sidebar-item <?php echo e(request()->routeIs('pembayaran-uang-saku.*') ? 'sidebar-active' : ''); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-6 flex-shrink-0">
            ...
            <div class="flex items-center gap-3">
                <span class="text-sm text-gray-600"><?php echo e(now()->isoFormat('dddd, D MMMM Y')); ?></span>
            </div>
        </header>
...
</html><?php /**PATH C:\Users\USER\pbl-payment-system\resources\views/layouts/app.blade.php ENDPATH**/ ?>