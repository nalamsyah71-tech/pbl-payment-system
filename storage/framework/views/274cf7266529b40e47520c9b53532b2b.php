...
<?php $__env->startSection('title', 'Pembayaran Uang Saku'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <span class="font-semibold text-slate-700">Uang Saku</span>
...
<div class="space-y-5">
    ...
    <div class="flex flex-wrap justify-between items-start gap-3">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-0.5 ml-10">Kelola data distribusi uang saku harian peserta</p>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
        ...
        <div class="flex flex-wrap items-end gap-3">
            <div class="flex-1 min-w-[220px]">
                ...
                <div class="relative">
                    <select id="filter_kelas"
                            class="w-full appearance-none border border-slate-200 rounded-xl text-sm px-3 py-2.5 pr-9 bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-amber-300 focus:border-amber-400 transition-all cursor-pointer">
            ...
            <div class="flex items-center gap-1.5 bg-amber-50 border border-amber-200 text-amber-700 text-xs font-semibold px-3 py-2 rounded-xl">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2a1 1 0 01-.293.707L13 13.414V19a1 1 0 01-.553.894l-4 2A1 1 0 017 21v-7.586L3.293 6.707A1 1 0 013 6V4z"/>
                </svg>
                Filter aktif
                <a href="<?php echo e(route('pembayaran-uang-saku.index')); ?>" class="ml-1 text-amber-400 hover:text-amber-700">
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        <div class="flex items-center justify-between px-5 py-3.5 border-b border-slate-100 bg-slate-50/60">
            <span class="text-sm font-semibold text-slate-600">
                Daftar Pembayaran
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('kelas_id')): ?><span class="text-amber-500">· Kelas Terpilih</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </span>
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-amber-50/30 transition-colors group">
                        <td class="px-5 py-3.5">
                            <span class="font-mono text-xs font-bold text-amber-700 bg-amber-50 px-2 py-1 rounded-lg">
                        ...
                        <td class="px-5 py-3.5 text-center">
                            <span class="text-xs text-slate-500 bg-slate-100 px-2.5 py-1 rounded-lg">
                                <?php echo e($item->tgl_spby->format('d/m/Y')); ?>

                            </span>
                        </td>
                        <td class="px-5 py-3.5">
                            <div class="flex items-center justify-center gap-1">
                                <a href="<?php echo e(route('pembayaran-uang-saku.show', $item)); ?>"
                                ...
                                <a href="<?php echo e(route('pembayaran-uang-saku.pdf', $item)); ?>"
                                   class="p-2 text-red-500 hover:bg-red-50 hover:text-red-700 rounded-lg transition-all" title="Download PDF">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                                    </svg>
                                </a>
                                <form action="<?php echo e(route('pembayaran-uang-saku.destroy', $item)); ?>" method="POST"
                    ...
                    <tr>
                        <td colspan="6" class="px-5 py-16 text-center">
                            <div class="flex flex-col items-center gap-3">
                                ...
                                <p class="text-slate-500 font-semibold">Belum ada data pembayaran uang saku</p>
                                <a href="<?php echo e(route('pembayaran-uang-saku.create')); ?>" class="text-sm text-amber-600 font-semibold hover:text-amber-700">
                                    + Tambah Sekarang
                                </a>
                            </div>
                        </td>
...
(function() {
    ...
    const pdfBase   = '<?php echo e(route("pembayaran-uang-saku.pdf-kelas", ["kelas" => "__ID__"])); ?>';
    const excelBase = '<?php echo e(route("pembayaran-uang-saku.excel-kelas", ["kelas" => "__ID__"])); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Project PBL final\pbl-payment-system\resources\views/pembayaran/uang_saku/index.blade.php ENDPATH**/ ?>