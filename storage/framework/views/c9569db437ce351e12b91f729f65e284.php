    ...
    <div class="relative w-full flex flex-col lg:flex-row">
        ...
        <div class="hidden lg:flex flex-1 flex-col justify-center px-16 py-12">
            <div class="max-w-md">
                ...
                <div class="space-y-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [['📱','Pulsa Internet','Kelola pembayaran pulsa harian peserta'],['🛡️','Asuransi BPJS','Manajemen premi asuransi otomatis'],['💰','Uang Saku','Kalkulasi dan distribusi uang saku']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="flex items-center gap-4" style="background: rgba(255,255,255,0.08); backdrop-filter: blur(10px); border-radius: 12px; padding: 14px 16px; border: 1px solid rgba(255,255,255,0.1);">
                        <span class="text-2xl"><?php echo e($f[0]); ?></span>
                        <div>
                            <p class="text-white font-semibold text-sm"><?php echo e($f[1]); ?></p>
                            <p class="text-indigo-300 text-xs"><?php echo e($f[2]); ?></p>
                        </div>
                    </div>
        ...
        <div class="flex-1 lg:max-w-md flex items-center justify-center p-6 lg:p-12">
            <div class="w-full max-w-sm fade-up">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-2xl">
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4 fade-up-3">
                        <?php echo csrf_field(); ?>
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" value="<?php echo e(old('email', 'admin@test.com')); ?>"
                ...
                <p class="text-center text-indigo-300/60 text-xs mt-6">
                    © <?php echo e(date('Y')); ?> PBL Payment System · Nizar Alamsyah
                </p>
            </div>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\USER\Project PBL final\pbl-payment-system\resources\views/login.blade.php ENDPATH**/ ?>