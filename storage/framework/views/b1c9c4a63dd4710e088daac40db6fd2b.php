...
<?php $__env->startSection('title', 'Pembayaran Asuransi BPJS'); ?>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
        ...
        <div class="flex flex-wrap items-end gap-3">
            ...
            <div class="flex items-center gap-1.5 bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-semibold px-3 py-2 rounded-xl">
                ...
                Filter aktif
                <a href="<?php echo e(route('pembayaran-asuransi.index')); ?>" class="ml-1 text-emerald-400 hover:text-emerald-700">
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        <div class="flex items-center justify-between px-5 py-3.5 border-b border-slate-100 bg-slate-50/60">
            <span class="text-sm font-semibold text-slate-600">
                Daftar Pembayaran
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('kelas_id')): ?><span class="text-emerald-500">· Kelas Terpilih</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </span>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-emerald-50/30 transition-colors group">
                        ...
                        <td class="px-5 py-3.5 text-xs text-slate-500"><?php echo e($item->no_sk ?? '-'); ?></td>
                        <td class="px-5 py-3.5">
                            <span class="text-sm font-semibold text-slate-700"><?php echo e($item->kelas->nama_kelas ?? '-'); ?></span>
                        </td>
                        <td class="px-5 py-3.5 text-right">
                            <span class="text-sm font-semibold text-slate-700"><?php echo e($item->jumlah_peserta ?? '-'); ?></span>
                        </td>
                        <td class="px-5 py-3.5 text-right">
                            <span class="font-bold text-slate-800 text-sm">Rp <?php echo e(number_format($item->total_premi, 0, ',', '.')); ?></span>
                        </td>
                        ...
                        <td class="px-5 py-3.5">
                            <div class="flex items-center justify-center gap-1">
                                <a href="<?php echo e(route('pembayaran-asuransi.show', $item)); ?>"
                                ...
                                <a href="<?php echo e(route('pembayaran-asuransi.pdf', $item)); ?>"
                                   class="p-2 text-red-500 hover:bg-red-50 hover:text-red-700 rounded-lg transition-all" title="Download PDF">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                                    </svg>
                                </a>
                                <form action="<?php echo e(route('pembayaran-asuransi.destroy', $item)); ?>" method="POST"
                    ...
                    <tr>
                        <td colspan="7" class="px-5 py-16 text-center">
                            <div class="flex flex-col items-center gap-3">
                                ...
                                <a href="<?php echo e(route('pembayaran-asuransi.create')); ?>" class="text-sm text-emerald-600 font-semibold hover:text-emerald-700">
                                    + Tambah Sekarang
                                </a>
                            </div>
                        </td>
...
(function() {
    ...
    const pdfBase   = '<?php echo e(route("pembayaran-asuransi.pdf-kelas", ["kelas" => "__ID__"])); ?>';
    const excelBase = '<?php echo e(route("pembayaran-asuransi.excel-kelas", ["kelas" => "__ID__"])); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Project PBL final\pbl-payment-system\resources\views/pembayaran/asuransi/index.blade.php ENDPATH**/ ?>