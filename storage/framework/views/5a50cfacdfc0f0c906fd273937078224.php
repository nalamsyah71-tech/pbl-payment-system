...
<?php $__env->startSection('title', 'Edit Kejuruan'); ?>
...
<div class="max-w-lg">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <form action="<?php echo e(route('kejuruan.update', $kejuruan)); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Nama Kejuruan <span class="text-red-500">*</span></label>
                <input type="text" name="nama" value="<?php echo e(old('nama', $kejuruan->nama)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Project PBL final\pbl-payment-system\resources\views/kejuruan/edit.blade.php ENDPATH**/ ?>