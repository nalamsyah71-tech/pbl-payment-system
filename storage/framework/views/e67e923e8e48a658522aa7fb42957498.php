...
<head>
    <meta charset="UTF-8">
    <title>Daftar Asuransi BPJS - <?php echo e($kelas->nama_kelas); ?></title>
    <style>
...
<body>
    <div class="header">
        ...
        <p>Kejuruan: <?php echo e($kejuruan->nama); ?> &nbsp;|&nbsp; MAK: <?php echo e($kelas->mak_asuransi ?? '-'); ?></p>
    ...
    <table style="border:none; margin-bottom:12px;">
        ...
        <tr>
            ...
            <td style="border:none; font-weight:bold; color:#166534;" colspan="3">: Rp <?php echo e(number_format($totalPremi, 0, ',', '.')); ?></td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">Rp <?php echo e(number_format($item->total_premi, 0, ',', '.')); ?></td>
            </tr>
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-right"><strong>Rp <?php echo e(number_format($totalPremi, 0, ',', '.')); ?></strong></td>
            </tr>
        </tfoot>
    </table>
    <?php else: ?>
...
</html><?php /**PATH C:\Users\USER\Project PBL final\pbl-payment-system\resources\views/pdf/asuransi-kelas.blade.php ENDPATH**/ ?>