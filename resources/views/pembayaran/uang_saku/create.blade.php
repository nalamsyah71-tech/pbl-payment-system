@extends('layouts.app')
@section('title', 'Input Pembayaran Uang Saku')
@section('breadcrumb')
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
        ...
        <form method="POST" action="{{ route('pembayaran-uang-saku.store') }}" id="formUangSaku">
            @csrf
            ...
            <div class="flex gap-3 mt-6">
                ...
                <a href="{{ route('pembayaran-uang-saku.index') }}" class="px-6 py-2 border border-slate-300 rounded-lg text-slate-600 hover:bg-slate-50">
                    Batal
                </a>
            </div>
        </form>
