...
<head>
    ...
    <title>@yield('title', 'PBL Payment System') – Sistem Pembayaran</title>
    ...
    <aside class="fixed lg:relative z-40 flex flex-col h-full transition-all duration-300 ease-in-out flex-shrink-0"
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-2 space-y-0.5">
            ...
            <a href="{{ route('kejuruan.index') }}"
               class="nav-item {{ request()->routeIs('kejuruan.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('pelatihan.index') }}"
               class="nav-item {{ request()->routeIs('pelatihan.*') ? 'active' : '' }}">
                <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('peserta.index') }}"
               class="nav-item {{ request()->routeIs('peserta.*') ? 'active' : '' }}">
                <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('pembayaran-pulsa.index') }}"
               class="nav-item {{ request()->routeIs('pembayaran-pulsa.*') ? 'active' : '' }}">
                <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('pembayaran-asuransi.index') }}"
               class="nav-item {{ request()->routeIs('pembayaran-asuransi.*') ? 'active' : '' }}">
                <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('pembayaran-uang-saku.index') }}"
               class="nav-item {{ request()->routeIs('pembayaran-uang-saku.*') ? 'active' : '' }}">
                <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
